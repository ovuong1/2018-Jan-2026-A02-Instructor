...
public class Library
{
	...
	public Result<InvoiceView> AddEditInvoice(InvoiceView invoiceView)
	{
		...
		//	These are processing rueles that need to be satisfied
		//		for valid data
		...
		//	rule:	Invoice lines must be provided
		...
		//	rule:	for each invoice line, the quanity cannot be less than one	
		...
		//	Retrieve the invoice from the database or create an new one if it does not
		//		exist.
